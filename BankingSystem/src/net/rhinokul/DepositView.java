...
/**
 * Servlet implementation class DepositView
 */
...
public class DepositView extends HttpServlet {
    ...
    public void service(HttpServletRequest request,
      ...
      throws IOException, ServletException {
        ...
        writer.println("<b>");
        writer.println("<form action=\"/BankingSystem/DepositAmount\" >");
        writer.println("Enter User ID: <input type=text name=\"userid\"><br/>");
        writer.println("Enter Your PIN: <input type=text name=\"pin\"><br/>");
        writer.println("Enter Amount that you want to deposit: <input type=text name=\"amount\"><br/>");
        writer.println("<br/>");
        writer.println("<input type=submit value=\"Deposit Amount\">");
        writer.println("</form>");
        writer.println("</b>");
        writer.println("</div>");
